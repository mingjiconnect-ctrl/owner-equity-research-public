...
EXPECTED_FUTU_PUBLIC_RESOURCES = {
    ...
    "owner_research/resources/futu/extension_schemas/v2/futu-runtime-isolation-authorization.schema.json",
    "owner_research/resources/futu/extension_schemas/v2/futu-runtime-isolation-receipt.schema.json",
    "owner_research/resources/futu/extension_schemas/v2/futu-supply-chain-receipt.schema.json",
